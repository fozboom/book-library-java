...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorMessage> handleDataAccessException(final DataAccessException ex,
																  final WebRequest request) {
	...
	public ResponseEntity<ErrorMessage> handleHttpServerErrorException(final Exception ex, final WebRequest request) {
		ErrorMessage errorMessage = new ErrorMessage(HttpStatus.INTERNAL_SERVER_ERROR.value(),
				new Date(),
